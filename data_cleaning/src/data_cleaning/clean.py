...
system_lookup = (
    ...
    .filter(pl.col("system").is_not_null() & (pl.col("system").str.strip_chars() != ""))
...
df = (
    ...
    .with_columns(
        pl.when(pl.col("system").is_null() | (pl.col("system").str.strip_chars() == ""))
...
id_like_columns = [
    col for col in result.columns if ("id" in col.lower() or col.lower() == "nces_zip")
]
