...
CONFIG = ExportScraperConfig(
    ...
    export_button_id=(
        "CPH_ReportCard_SupportingDataContent_btnEducatorDemographicsDataCSVExport_CD"
    ),
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Export ALSDE Educator Demographics CSV data for requested years."
    )
    parser.add_argument(
        "--years",
        nargs="*",
