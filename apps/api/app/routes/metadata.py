...
def _get_missing_features_for_year(
    ...
    cur.execute(base_query, (selected_year, selected_year, school_key))
    ...
    try:
        with conn.cursor() as cur:
            ...
            return SchoolSimulationMetadataResponse(
                ...
                is_simulatable=selected_status.is_simulatable
                if selected_status
                else False,
                missing_features=selected_status.missing_features
                if selected_status
                else [],
