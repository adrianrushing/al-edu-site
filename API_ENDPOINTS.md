...
| `GET /schools/{school_key}/simulation-metadata` | `core.dim_school_info`, `core.fact_edunomics`, `core.fact_teacher_experience`, `core.fact_student_demographics` | `SchoolSimulationMetadataResponse` | Returns simulation readiness metadata for a school, including available simulation years and missing features per year |
